...
list:[
    ...
    {name:'Typhoon',        owner:'jasperblues',   desc:'IoC容器啊～～'},
...
list:[
    ...
    {name:'Interpreter',        owner:'node-app',     desc:'Node.js for iOS 7'}
]
},
...
list:[
    ...
    {name:'SVProgressHUD',            owner:'samvermette',       desc:'一个HUD 样式类似MB_HUD 有一些进度等'},
...
{name:'Xcode插件/开发',
list:[
    {name:'Alcatraz',               owner:'mneorr',       desc:'Xcode5插件 管理和发现插件～～'},
    ...
    {name:'HOStringSense-for-Xcode',owner:'holtwick',     desc:'Xcode5插件 直接编辑转义字符串'},
